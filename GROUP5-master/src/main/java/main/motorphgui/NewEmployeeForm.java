...
public class NewEmployeeForm extends JFrame {
    ...
    String[] numericFields = {"Employee ID", "Monthly Salary", "Rice Subsidy", "Phone Allowance", "Clothing Allowance", "Hourly Rate"};
    String[] numericIDs = {"SSS", "PhilHealth", "TIN", "Pag-IBIG"};
    ...
    try {
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            // Numeric validations
            if (arrayContains(numericFields, label) || arrayContains(numericIDs, label)) {
